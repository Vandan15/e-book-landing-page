  ...
  const reviews = [
    {
      ...
      reviewTitle: "",
      review:
        "I run a branding agency in California, and we aim to attract high-ticket clients worldwide. After reading this e-book and being thoroughly impressed, we implemented its solutions. The results were amazing, our leader cost dropped by 35%, and our conversion rate increased by 24%.",
    },
    {
      id: 2,
      image: "/review-2.jpg",
    ...
    >
      <div className="flex w-full max-w-[1636px] flex-col items-center justify-center gap-[32px] px-[100px] py-[42px] max-xl:px-[60px] max-lg:flex-col max-sm:px-[30px]">
        ...
        <h1 className="relative w-full max-w-[800px] text-center text-[28px] font-extrabold text-white md:text-[32px]">
          {`See How This E-book Helped Its Readers Generate High-quality leaders`}
