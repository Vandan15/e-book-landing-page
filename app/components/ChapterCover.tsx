...
const ChapterCover = () => {
  const chapterList = [
    {
      faqId: 1,
      question: "Chapter-1: Overview of Meta Ads leader Generation Ecosystem",
      answer:
        "Different ways to generate leaders from Meta Ads, most people don’t consider.",
    },
    {
      faqId: 2,
      question:
        "Chapter-2: Exact Way to Set up leader Generation Campaign in Meta",
    ...
    },
    {
      faqId: 4,
      question:
        "Chapter-4: Lookalike or Advantage+: Which is Better for leader Generation?",
      answer:
    ...
    },
    {
      faqId: 6,
      question:
        "Chapter-6: How to Design Instant Form for High-Quality leaders That Convert?",
      answer: "",
    },
    {
      faqId: 7,
      question:
        "Chapter-7: How to Optimize a Landing Page to Collect High-Quality leaders?",
      answer: "",
    },
    {
      faqId: 8,
      question: "Chapter-8: Common Mistakes That Decrease the leader Quality",
      answer: "Identifying and avoiding common pitfalls.",
    },
    {
      faqId: 9,
      question:
        "Chapter-9: Immediate Steps to Implement RIGHT NOW for High-Quality leaders",
      answer: "",
    },
    {
      faqId: 10,
      question:
        "Chapter-10: Secrets to Avoid Fake leaders & Collect ONLY High-Quality leaders",
      answer: "",
    },
    {
      faqId: 11,
      question:
        "Chapter-11: Common leaders-Related Issues & Their Effective Solutions",
      answer:
        "Troubleshooting common leader generation problems. \n\nProblem 1: Duplicate leaders\nProblem 2: leaders Are Saying 'I Didn’t Fill Out the Form'\nProblem 3: leader Cost Is Too High\nProblem 4: Getting Quality leaders But Quality Is Not Consistent\nProblem 5: leaders Have No Buying Intent\nProblem 6: leaders Are Not Picking Calls or Replying to Messages\nProblem 7: leaders Express Interest in the Future, But Not Now\nProblem 8: Getting leaders From Outside Your Desired Geographic Location\nProblem 9: leaders are Filling Fake Details",
    },
    {
      faqId: 12,
      question: "Chapter-12: How to Write Ad Copy For High-Quality leaders?",
      answer: "",
    },
    {
      faqId: 13,
      question:
        "Chapter-13: How to Analyze and Optimize leader Generation Campaign?",
      answer: "",
    },
    {
      faqId: 14,
      question:
        "Chapter-14: How to Scale Campaign Without Compromising leader Quality?",
      answer: "Best practices for scaling while maintaining leader quality.",
    },
    {
      faqId: 15,
      question:
        "Chapter-15: Using Meta’s leader Center to Manage leaders Effectively",
      answer: "How to use Meta’s built-in tools to handle leaders.",
    },
    {
      faqId: 16,
      question:
        "Chapter-16: Most Important leader Generation Metrics to Track Your Performance",
      answer: "",
    },
    {
      faqId: 17,
      question:
        "Chapter-17: A Perfect Dashboard For leader Generation Campaign",
      answer: "",
    },
    {
      faqId: 18,
    ...
    {
      faqId: 19,
      question: "Chapter-19: Industry-Specific leader Generation Tips",
      answer:
        "Covering real estate, finance, insurance, stock market, home services, courses, consultation business, and a lot more.",
    },
    {
      faqId: 20,
      question: "Chapter-20: leaders Got Converted - Now What?",
      answer: "Strategies to get maximum value from converted leaders.",
    },
  ];
    ...
    >
      <div className="flex w-full max-w-[1636px] flex-col items-center justify-center gap-[32px] px-[100px] py-[42px] max-xl:px-[60px] max-lg:flex-col max-sm:px-[30px]">
        ...
        <h1 className="relative w-full text-center text-[28px] font-extrabold text-white max-sm:text-[38px] md:text-[32px]">
          {` Chapters Covered to Make You Master of leader Generation`}
        ...
        <div className="flex max-w-[800px] items-center justify-start max-lg:flex-wrap">
          ...
          {/* <div className="flex w-1/3 flex-col border-r-[1px] border-r-[#ffffff0d] px-[42px] max-xl:px-[18px] max-lg:min-w-[300px] max-lg:flex-1 max-md:min-w-full max-md:border-r-0">
            <Chapter
              chapterNo="Chapter 1"
              chapterTitle="Overview of Meta Ads leader Generation Ecosystem"
              chapterDescription="Different ways to generate leaders from Meta Ads, most people don’t consider"
            />
            <Chapter
              chapterNo="Chapter 2"
              chapterTitle="Exact Way to Set up leader Generation Campaign in Meta"
            ...
            <Chapter
              chapterNo="Chapter 4"
              chapterTitle="Lookalike or Advantage+: Which is Better for leader Generation?"
            ...
            <Chapter
              chapterNo="Chapter 6"
              chapterTitle="How to Design Instant Form for High-Quality leaders That Convert?"
              chapterDescription="-"
            />
            <Chapter
              chapterNo="Chapter 7"
              chapterTitle="How to Optimize a Landing Page to Collect High-Quality leaders?"
          ...
          {/* <div className="flex w-1/3 flex-col border-r-[1px] border-r-[#ffffff0d] px-[42px] max-xl:px-[18px] max-lg:min-w-[300px] max-lg:flex-1 max-lg:border-r-0 max-md:min-w-full">
            <Chapter
              chapterNo="Chapter 8"
              chapterTitle="Common Mistakes That Decrease the leader Quality"
              chapterDescription="Identifying and avoiding common pitfalls"
            />
            <Chapter
              chapterNo="Chapter 9"
              chapterTitle="Immediate Steps to Implement RIGHT NOW for High-Quality leaders"
              chapterDescription="-"
            />
            <Chapter
              chapterNo="Chapter 10"
              chapterTitle="Secrets to Avoid Fake leaders & Collect ONLY High-Quality leaders"
              chapterDescription="-"
            />
            <Chapter
              chapterNo="Chapter 11"
              chapterTitle="Common leaders-Related Issues & Their Effective Solutions"
              chapterDescription="Troubleshooting common leader generation problems"
            />
            <Chapter
              chapterNo="Chapter 12"
              chapterTitle="How to Write Ad Copy For High-Quality leaders?"
              chapterDescription="-"
            />
            <Chapter
              chapterNo="Chapter 13"
              chapterTitle="How to Analyze and Optimize leader Generation Campaign?"
              chapterDescription="-"
            />
            <Chapter
              chapterNo="Chapter 14"
              chapterTitle="How to Scale Campaign Without Compromising leader Quality?"
          ...
          {/* <div className="flex w-1/3 flex-col px-[42px] max-xl:px-[18px] max-lg:min-w-[300px] max-lg:flex-1 max-md:min-w-full">
            <Chapter
              ...
              chapterTitle="Using Meta’s leader Center to Manage leaders Effectively"
              chapterDescription="How to use Meta’s built-in tools to handle leaders"
            />
            <Chapter
              chapterNo="Chapter 16"
              chapterTitle="Most Important leader Generation Metrics to Track Your Performance"
              chapterDescription="-"
            />
            <Chapter
              chapterNo="Chapter 17"
              chapterTitle="A Perfect Dashboard For leader Generation Campaign"
              chapterDescription="-"
            />
            <Chapter
            ...
            <Chapter
              ...
              chapterTitle="Industry-Specific leader Generation Tips"
            ...
            <Chapter
              ...
              chapterTitle="leaders Got Converted - Now What?"
              chapterDescription="Strategies to get maximum value from converted leaders"
            />
            <Chapter
